...
skynet.start(function()
    ...
    local loginserver = clusterservice("logind", conf.login.ip, conf.login.port, conf.login.network_ip, conf.login.network_port, conf.serverid)
    ...
    skynet.call(gamed, "lua", "open" , conf.gameserver)
