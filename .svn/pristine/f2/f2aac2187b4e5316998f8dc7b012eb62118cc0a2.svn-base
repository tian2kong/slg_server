...
function CMD.debug(name, msg)
	logger.debug(string.format("%s [%s] %s",timext.to_unix_time_stamp(), name, msg))
end

function CMD.info(name, msg)
	logger.info(string.format("%s [%s] %s",timext.to_unix_time_stamp(), name, msg))
end

function CMD.warning(name, msg)
	logger.warning(string.format("%s [%s] %s",timext.to_unix_time_stamp(), name, msg))
end

function CMD.error(name, msg)
	logger.error(string.format("%s [%s] %s",timext.to_unix_time_stamp(), name, msg))
end

function CMD.fatal(name, msg)
	logger.fatal(string.format("%s [%s] %s",timext.to_unix_time_stamp(), name, msg))
end
